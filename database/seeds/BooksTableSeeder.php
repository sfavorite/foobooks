...
class BooksTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $author_id = \Foobooks\Author::where('last_name', '=', 'Fitzgerald')->pluck('id')->first();
        ...
        $author_id = \Foobooks\Author::where('last_name', '=', 'Plath')->pluck('id')->first();
        DB::table('books')->insert([
            'created_at' => Carbon\Carbon::now()->toDateTimeString(),
            'updated_at' => Carbon\Carbon::now()->toDateTimeString(),
            'title' => 'The Bell Jar',
        ...
        $author_id = \Foobooks\Author::where('last_name','=','Angelou')->pluck('id')->first();
        DB::table('books')->insert([
            'created_at' => Carbon\Carbon::now()->toDateTimeString(),
            'updated_at' => Carbon\Carbon::now()->toDateTimeString(),
